class ErrorCodes {
  ...
  static final String CREATE_ORDER_API_CONNECTION = 'E-008';
  static final String UPDATE_NUM_ORDER_FOOD_ITEM_FAIL_BACKEND = 'E-009';
  static final String UPDATE_NUM_ORDER_FOOD_ITEM_API_CONNECTION = 'E-010';
  static final String EDIT_ORDER_FAIL_BACKEND = 'E-011';
  static final String EDIT_ORDER_API_CONNECTION = 'E-012';
}