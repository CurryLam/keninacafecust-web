...
import 'package:keninacafecust_web/Menu/dineInOrTakeAway.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      // home: const LoginPage(tableNo: null),
...
class LoginPage extends StatefulWidget {
  // const LoginPage({super.key, this.tableNo});
                            ...
                            child: TextButton(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.bold,
                                  shadows: const [Shadow(color: Colors.transparent, offset: Offset(0, -4))],
